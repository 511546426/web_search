...
- ⚠️ **场景必须多样化**：每次生成必须选择与**该商品品类和风格匹配**的场景，不同商品之间禁止重复使用相同场景
- ⚠️ **特别禁止**：不要用咖啡馆/红砖墙/水泥墙/纯色背景/白墙/摄影棚。每次必须换不同的场景类型
- 根据商品品类和调性选择**一个最匹配的实景环境**（从以下列表选，但不限于此）：
  - **服装类**：都市街头 / 海滨栈道 / 公园绿荫 / 写字楼大厅 / 精品买手店 / 艺术画廊 / 天台泳池 / 老城区巷弄 / 日式庭院 / 音乐节现场 / 酒店大堂 / 书房 / 露台花园 / 竹林小径 / 地铁站台 / 校园林荫道 / 复古理发店 / 美术馆
  - **美妆类**：精致梳妆台 / 落地窗旁晨光 / 闺蜜聚餐 / 花园 / 浴室 / 衣帽间 / 卧室 / 吧台 / 泳池边 / 舞蹈室 / 瑜伽房 / 露台 / 酒店浴室 / 植物温室
  - **数码/家电类**：极简书桌 / 夜景天台 / 创意工作室 / 客厅 / 书房 / 咖啡吧台 / 酒店房间 / 会议室 / 智能家居展厅 / 电竞房 / 录音棚
  - **食品饮料类**：温馨厨房 / 野餐草地 / 家庭餐桌 / 阳台 / 吧台 / 街边小吃摊 / 露营帐篷 / 办公室茶水间 / 超市货架 / 日式居酒屋 / 烧烤架旁
  - **家居日用类**：客厅 / 卧室 / 阳台 / 浴室 / 书房 / 餐厅 / 庭院 / 酒店房间 / 民宿 / 样板间 / 阁楼 / 阳光房
  - **运动户外类**：运动场 / 健身房 / 公园跑道 / 山顶 / 海边 / 泳池 / 瑜伽房 / 街头篮球场 / 森林小径 / 滑雪场
  - **母婴类**：儿童房 / 客厅地垫 / 公园草坪 / 早教教室 / 卧室 / 婴儿床旁 / 游乐场
- **同一环境内必须有区域变化**：比如选"餐厅"，镜头应从门口→卡座→吧台→窗边移动；选"公园"应从入口→长椅→湖边→草坪移动；**禁止所有场景在同一个位置拍摄**
- 每个场景的 camera_angle 中必须包含该统一环境的具体描述（位置+光线+细节）
...
{{
  ...
  "setting": "统一的场景环境描述（如「顶层露台花园，藤编家具环绕，远处城市天际线在夕阳下泛着金光」）——禁止使用咖啡馆/红砖墙/水泥墙",
  "scenes": [
    {{
      "scene": 1,
...
- ⚠️ **场景必须多样化**：每次生成必须选择匹配该商品品类的场景，不同商品之间禁止重复使用相同场景类型
- ⚠️ **特别禁止**：不要用咖啡馆/红砖墙/水泥墙/纯色背景/白墙/摄影棚
- 根据商品品类和剧情调性选择**一个最匹配的实景环境**（从以下列表选，但不限于此）：
  - **服装类**：都市街头 / 海滨栈道 / 公园绿荫 / 写字楼大厅 / 精品买手店 / 艺术画廊 / 天台泳池 / 老城区巷弄 / 日式庭院 / 音乐节现场 / 酒店大堂 / 书房 / 露台花园 / 竹林小径 / 地铁站台 / 校园林荫道 / 复古理发店 / 美术馆
  - **美妆类**：精致梳妆台 / 落地窗旁晨光 / 闺蜜聚餐 / 花园 / 浴室 / 衣帽间 / 卧室 / 吧台 / 泳池边 / 舞蹈室 / 瑜伽房 / 露台 / 酒店浴室 / 植物温室
  - **数码/家电类**：极简书桌 / 夜景天台 / 创意工作室 / 客厅 / 书房 / 咖啡吧台 / 酒店房间 / 会议室 / 智能家居展厅 / 电竞房 / 录音棚
  - **食品饮料类**：温馨厨房 / 野餐草地 / 家庭餐桌 / 阳台 / 吧台 / 街边小吃摊 / 露营帐篷 / 办公室茶水间 / 超市货架 / 日式居酒屋 / 烧烤架旁
  ...
  - **运动户外类**：运动场 / 健身房 / 公园跑道 / 山顶 / 海边 / 泳池 / 瑜伽房 / 街头篮球场 / 森林小径 / 滑雪场
  - **母婴类**：儿童房 / 客厅地垫 / 公园草坪 / 早教教室 / 卧室 / 婴儿床旁 / 游乐场
- **同一环境内必须有区域变化**：比如选"餐厅"，剧情应从门口→卡座→吧台→窗边推进；选"公园"应从入口→长椅→湖边→草坪推进；**禁止所有场景在同一个位置拍摄**
- 每个场景的 location 必须描述统一环境中的具体位置和细节（位置+光线+陈设）
